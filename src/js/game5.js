(function() {
  ...
  Game5.prototype = {
    ...
    create: function () {
      ...
      this.bad = this.createThings('bad', 10);
    ...
    createThings : function (spriteName, qty, x, y){
      ...
      for (var i = 0; i < qty; i++)
      {
        if(x && y){
          ...
          var s = sprites.create(this.game.rnd.integerInRange(0, 500), this.game.rnd.integerInRange(0, 500), spriteName);
        }
